...
$products = [
    [
        'name' => 'STRIDEX URBAN', 'color' => 'Midnight Red', 'price' => '79.99', 'rating' => 4, 'reviews' => 246,
        'image' => 'men/bestseller.png', 'bg' => 'bg-red', 'badge' => 'BESTSELLER', 'swatches'=> ['#c8102e', '#111', '#e8e8e8'],
    ],
    [
        'name' => 'STRIDEX FLEX', 'color' => 'Cloud White', 'price' => '79.99', 'rating' => 4, 'reviews' => 246,
        'image' => 'men/newdrop.png', 'bg' => 'bg-black', 'badge' => 'NEW DROP', 'swatches'=> ['#ffffff', '#111', '#e8e8e8'],
    ],
    [
        'name' => 'STRIDEX CORE', 'color' => 'Carbon Gray', 'price' => '89.99', 'rating' => 4, 'reviews' => 246,
        'image' => 'men/limited.png', 'bg' => 'bg-gray', 'badge' => 'LIMITED', 'swatches'=> ['#ff5a1f', '#111', '#e8e8e8'],
    ],
    // Add more men's shoes here if you want!
];
...
<head>
    ...
    <title>Men's Collection — <?= e($site['brand']) ?></title>
...
<section class="shop-page-header" id="shop">
    <div class="container">
        ...
        <h1 class="section-title center">MEN'S SHOES</h1>
    </div>
</section>
